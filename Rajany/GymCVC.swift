...
class GymFeedController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: AppConfig.gym_feed)
        URLSession.shared.dataTask(with: url!) { (data, response, error) in
            ...
            do {
                ...
                if let postsArray = json["gym"] as? [[String: String]] {
        ...
        collectionView?.register(GymFeedCell.self, forCellWithReuseIdentifier: cellId)
        setupNavBarButtons()
    ...
    func setupNavBarButtons() {
        ...
        let logo = UIBarButtonItem(image: UIImage(named: "logosmall")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleMore))
        let navItem = UINavigationItem(title: "Gym Ideas")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let GymFeedCell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! GymFeedCell
        
        GymFeedCell.post = posts[(indexPath as NSIndexPath).item]
        GymFeedCell.feedController = self
...
class GymFeedCell: UICollectionViewCell {
    var ref: FIRDatabaseReference!
    var feedController: GymFeedController?
    ...
    let likeButton: UIButton = GymFeedCell.buttonForTitle("", imageName: "like")
