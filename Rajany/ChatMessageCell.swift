...
class ChatMessageCell: UICollectionViewCell {
    ...
    let usernameTextView: UITextView = {
        let us = UITextView()
        us.font = UIFont.systemFont(ofSize: 8)
        us.translatesAutoresizingMaskIntoConstraints = false
        us.backgroundColor = UIColor.clear
        us.textColor = .black
        us.isEditable = false
        return us
    }()
    ...
    override init(frame: CGRect) {
        ...
        usernameTextView.bottomAnchor.constraint(equalTo: self.bottomAnchor).isActive = true
        usernameTextView.widthAnchor.constraint(equalToConstant: 80).isActive = true
        usernameTextView.heightAnchor.constraint(equalToConstant: 20).isActive = true
