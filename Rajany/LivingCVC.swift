...
import UIKit
import Firebase
class LivingPost: SafeJsonObject {
    var item: String?
...
class LivingFeedController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    
    var posts = [LivingPost]()
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: AppConfig.living_feed)
        URLSession.shared.dataTask(with: url!) { (data, response, error) in
            ...
            do {
                ...
                if let postsArray = json["living"] as? [[String: String]]{
                    
                    self.posts = [LivingPost]()
        ...
        collectionView?.register(LivingFeedCell.self, forCellWithReuseIdentifier: cellId)
        setupNavBarButtons()
    ...
    func setupNavBarButtons() {
        ...
        let logo = UIBarButtonItem(image: UIImage(named: "logosmall")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleMore))
        let navItem = UINavigationItem(title: "Living Ideas")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let LivingFeedCell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! LivingFeedCell
        
        LivingFeedCell.post = posts[(indexPath as NSIndexPath).item]
        LivingFeedCell.feedController = self
        
        return LivingFeedCell
    }
...
class LivingFeedCell: UICollectionViewCell {
    var ref: FIRDatabaseReference!
    var feedController: LivingFeedController?
    ...
    let likeButton: UIButton = LivingFeedCell.buttonForTitle("", imageName: "like")
