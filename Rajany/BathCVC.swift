...
class BathFeedController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: AppConfig.bathroom_feed)
        URLSession.shared.dataTask(with: url!) { (data, response, error) in
            ...
            do {
                ...
                if let postsArray = json["bathroom"] as? [[String: String]] {
        ...
        collectionView?.register(BathFeedCell.self, forCellWithReuseIdentifier: cellId)
        setupNavBarButtons()
    ...
    func setupNavBarButtons() {
        ...
        let logo = UIBarButtonItem(image: UIImage(named: "logosmall")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleMore))
        let navItem = UINavigationItem(title: "Bathroom Ideas")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let BathFeedCell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! BathFeedCell
        
        BathFeedCell.post = posts[(indexPath as NSIndexPath).item]
        BathFeedCell.feedController = self
...
class BathFeedCell: UICollectionViewCell {
    var ref: FIRDatabaseReference!
    var feedController: BathFeedController?
    ...
    let likeButton: UIButton = BathFeedCell.buttonForTitle("", imageName: "like")
