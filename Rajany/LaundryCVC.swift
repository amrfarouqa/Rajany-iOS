...
import UIKit
import Firebase
class LaundryPost: SafeJsonObject {
    var item: String?
...
class LaundryFeedController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    
    var posts = [LaundryPost]()
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: AppConfig.laundry_feed)
        URLSession.shared.dataTask(with: url!) { (data, response, error) in
            ...
            do {
                ...
                if let postsArray = json["laundry"] as? [[String: String]] {
                    
                    self.posts = [LaundryPost]()
                    
                    for postDictionary in postsArray {
                        let post = LaundryPost()
        ...
        collectionView?.register(LaundryFeedCell.self, forCellWithReuseIdentifier: cellId)
        setupNavBarButtons()
    ...
    func setupNavBarButtons() {
        ...
        let logo = UIBarButtonItem(image: UIImage(named: "logosmall")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleMore))
        let navItem = UINavigationItem(title: "Laundry Ideas")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let LaundryFeedCell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! LaundryFeedCell
        
        LaundryFeedCell.post = posts[(indexPath as NSIndexPath).item]
        LaundryFeedCell.feedController = self
        
        return LaundryFeedCell
    }
...
class LaundryFeedCell: UICollectionViewCell {
    var ref: FIRDatabaseReference!
    var feedController: LaundryFeedController?
    
    var post: LaundryPost? {
        didSet {
    ...
    let likeButton: UIButton = LaundryFeedCell.buttonForTitle("", imageName: "like")
