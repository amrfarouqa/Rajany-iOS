...
class WallFeedController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: AppConfig.wall_feed)
        URLSession.shared.dataTask(with: url!) { (data, response, error) in
            ...
            do {
                ...
                if let postsArray = json["wall"] as? [[String: String]] {
        ...
        collectionView?.register(WallFeedCell.self, forCellWithReuseIdentifier: cellId)
        setupNavBarButtons()
    ...
    func setupNavBarButtons() {
        ...
        let logo = UIBarButtonItem(image: UIImage(named: "logosmall")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleMore))
        let navItem = UINavigationItem(title: "Wall Cladding Ideas")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let WallFeedCell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! WallFeedCell
        
        WallFeedCell.post = posts[(indexPath as NSIndexPath).item]
        WallFeedCell.feedController = self
...
class WallFeedCell: UICollectionViewCell {
    var ref: FIRDatabaseReference!
    var feedController: WallFeedController?
    ...
    let likeButton: UIButton = WallFeedCell.buttonForTitle("", imageName: "like")
