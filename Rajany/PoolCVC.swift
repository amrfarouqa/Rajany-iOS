...
class PoolFeedController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: AppConfig.pool_feed)
        URLSession.shared.dataTask(with: url!) { (data, response, error) in
            ...
            do {
                ...
                if let postsArray = json["pool"] as? [[String: String]] {
        ...
        collectionView?.register(PoolFeedCell.self, forCellWithReuseIdentifier: cellId)
        setupNavBarButtons()
    ...
    func setupNavBarButtons() {
        ...
        let logo = UIBarButtonItem(image: UIImage(named: "logosmall")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleMore))
        let navItem = UINavigationItem(title: "Pool Ideas")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let PoolFeedCell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! PoolFeedCell
        
        PoolFeedCell.post = posts[(indexPath as NSIndexPath).item]
        PoolFeedCell.feedController = self
...
class PoolFeedCell: UICollectionViewCell {
    var ref: FIRDatabaseReference!
    var feedController: PoolFeedController?
    ...
    let likeButton: UIButton = PoolFeedCell.buttonForTitle("", imageName: "like")
