...
class BabyFeedController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: AppConfig.baby_feed)
        URLSession.shared.dataTask(with: url!) { (data, response, error) in
            ...
            do {
                ...
                if let postsArray = json["baby"] as? [[String: String]] {
        ...
        collectionView?.register(BabyFeedCell.self, forCellWithReuseIdentifier: cellId)
        setupNavBarButtons()
    ...
    func setupNavBarButtons() {
        ...
        let logo = UIBarButtonItem(image: UIImage(named: "logosmall")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleMore))
        let navItem = UINavigationItem(title: "Baby & Kids Ideas")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let BabyFeedCell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! BabyFeedCell
        
        BabyFeedCell.post = posts[(indexPath as NSIndexPath).item]
        BabyFeedCell.feedController = self
...
class BabyFeedCell: UICollectionViewCell {
    var ref: FIRDatabaseReference!
    var feedController: BabyFeedController?
    ...
    let likeButton: UIButton = BabyFeedCell.buttonForTitle("", imageName: "like")
