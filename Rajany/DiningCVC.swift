...
import UIKit
import Firebase
class DiningPost: SafeJsonObject {
    var item: String?
...
class DiningFeedController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    
    var posts = [DiningPost]()
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: AppConfig.dining_feed)
        URLSession.shared.dataTask(with: url!) { (data, response, error) in
            ...
            do {
                ...
                if let postsArray = json["dining"] as? [[String: String]] {
                    
                    self.posts = [DiningPost]()
        ...
        collectionView?.register(DiningFeedCell.self, forCellWithReuseIdentifier: cellId)
        setupNavBarButtons()
    ...
    func setupNavBarButtons() {
        ...
        let logo = UIBarButtonItem(image: UIImage(named: "logosmall")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleMore))
        let navItem = UINavigationItem(title: "Dining Ideas")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let DiningFeedCell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! DiningFeedCell
        
        DiningFeedCell.post = posts[(indexPath as NSIndexPath).item]
        DiningFeedCell.feedController = self
        
        return DiningFeedCell
    }
...
class DiningFeedCell: UICollectionViewCell {
    var ref: FIRDatabaseReference!
    var feedController: DiningFeedController?
    ...
    let likeButton: UIButton = DiningFeedCell.buttonForTitle("", imageName: "like")
