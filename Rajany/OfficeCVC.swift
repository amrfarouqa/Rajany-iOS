...
import UIKit
import Firebase
class OfficePost: SafeJsonObject {
    var item: String?
...
class OfficeFeedController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    
    var posts = [OfficePost]()
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: AppConfig.office_feed)
        URLSession.shared.dataTask(with: url!) { (data, response, error) in
            ...
            do {
                ...
                if let postsArray = json["office"] as? [[String: String]] {
                    
                    self.posts = [OfficePost]()
        ...
        collectionView?.register(OfficeFeedCell.self, forCellWithReuseIdentifier: cellId)
        setupNavBarButtons()
    ...
    func setupNavBarButtons() {
        ...
        let logo = UIBarButtonItem(image: UIImage(named: "logosmall")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleMore))
        let navItem = UINavigationItem(title: "Office Ideas")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let OfficeFeedCell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! OfficeFeedCell
        
        OfficeFeedCell.post = posts[(indexPath as NSIndexPath).item]
        OfficeFeedCell.feedController = self
        
        return OfficeFeedCell
    }
...
class OfficeFeedCell: UICollectionViewCell {
    var ref: FIRDatabaseReference!
    var feedController: OfficeFeedController?
    ...
    let likeButton: UIButton = OfficeFeedCell.buttonForTitle("", imageName: "like")
