...
import UIKit
import Firebase
class EntryPost: SafeJsonObject {
    var item: String?
...
class EntryFeedController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: AppConfig.entry_feed)
        URLSession.shared.dataTask(with: url!) { (data, response, error) in
            ...
            do {
                ...
                if let postsArray = json["entry"] as? [[String: String]] {
                    
                    self.posts = [EntryPost]()
        ...
        collectionView?.register(EntryFeedCell.self, forCellWithReuseIdentifier: cellId)
        setupNavBarButtons()
    ...
    func setupNavBarButtons() {
        ...
        let logo = UIBarButtonItem(image: UIImage(named: "logosmall")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleMore))
        let navItem = UINavigationItem(title: "Entry Ideas")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let EntryFeedCell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! EntryFeedCell
        
        EntryFeedCell.post = posts[(indexPath as NSIndexPath).item]
        EntryFeedCell.feedController = self
        
        return EntryFeedCell
    }
...
class EntryFeedCell: UICollectionViewCell {
    var ref: FIRDatabaseReference!
    var feedController: EntryFeedController?
    ...
    let likeButton: UIButton = EntryFeedCell.buttonForTitle("", imageName: "like")
