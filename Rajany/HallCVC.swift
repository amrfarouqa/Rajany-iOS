...
class HallFeedController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: AppConfig.hall_feed)
        URLSession.shared.dataTask(with: url!) { (data, response, error) in
            ...
            do {
                ...
                if let postsArray = json["hall"] as? [[String: String]] {
        ...
        collectionView?.register(HallFeedCell.self, forCellWithReuseIdentifier: cellId)
        setupNavBarButtons()
    ...
    func setupNavBarButtons() {
        ...
        let logo = UIBarButtonItem(image: UIImage(named: "logosmall")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleMore))
        let navItem = UINavigationItem(title: "Hall Ideas")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let HallFeedCell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! HallFeedCell
        
        HallFeedCell.post = posts[(indexPath as NSIndexPath).item]
        HallFeedCell.feedController = self
...
class HallFeedCell: UICollectionViewCell {
    var ref: FIRDatabaseReference!
    var feedController: HallFeedController?
    ...
    let likeButton: UIButton = HallFeedCell.buttonForTitle("", imageName: "like")
