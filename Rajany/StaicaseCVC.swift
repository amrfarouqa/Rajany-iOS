...
class StaircasePost: SafeJsonObject {
    var item: String?
...
class StaircaseFeedController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    
    var posts = [StaircasePost]()
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: AppConfig.staircase_feed)
        URLSession.shared.dataTask(with: url!) { (data, response, error) in
            ...
            do {
                ...
                if let postsArray = json["staircase"] as? [[String: String]] {
                    
                    self.posts = [StaircasePost]()
                    
                    for postDictionary in postsArray {
                        let post = StaircasePost()
        ...
        collectionView?.register(StaicaseFeedCell.self, forCellWithReuseIdentifier: cellId)
        setupNavBarButtons()
    ...
    func setupNavBarButtons() {
        ...
        let logo = UIBarButtonItem(image: UIImage(named: "logosmall")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleMore))
        let navItem = UINavigationItem(title: "Staircase Ideas")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let StaicaseFeedCell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! StaicaseFeedCell
        
        StaicaseFeedCell.post = posts[(indexPath as NSIndexPath).item]
        StaicaseFeedCell.feedController = self
        
        return StaicaseFeedCell
    }
...
class StaicaseFeedCell: UICollectionViewCell {
    var ref: FIRDatabaseReference!
    var feedController: StaircaseFeedController?
    
    var post: StaircasePost? {
        didSet {
    ...
    let likeButton: UIButton = StaicaseFeedCell.buttonForTitle("", imageName: "like")
